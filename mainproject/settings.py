...
SECRET_KEY = 'django-insecure-)$$64+tm$9d#0tz76kow929r^+d!#i573y$f6^n1csdhaslssn'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "templates")],  # Ensure the project-level templates folder is included
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
